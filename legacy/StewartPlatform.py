...
class StewartPlatform:
    ...
    def cls(self):
        os.system('cls')
    def set_env(self, use_gui=False):
        # Configuration pour améliorer la stabilité du GUI
        import os
        if use_gui:
    ...
    def start_simmulation(self, data, simulation=False, flag = True, use_gui=False):
        self.set_env(use_gui)         # set the environment
        ...
        if simulation:
            try:
                ...
                print("Error stopping video logging")
        
        # Déconnexion propre pour éviter les segfaults
        try:
            p.disconnect()
    ...
    def fit(self, datas, flag, simulation=False, use_gui=False):
        self.set_env(use_gui)         # set the environment
        self.set_constraints()  # set the constraints
